    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('administrador', 'Administrador'), ('propietario', 'Propietario'), ('arrendatario', 'Arrendatario')], default='arrendatario', max_length=20, verbose_name='Tipo de usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arrendatario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrendamientos', to=settings.AUTH_USER_MODEL)),
